...
# ═══════════════════════════════════════════════════════════════════════════════
# CONFIGURATION, THRESHOLDS & ASSETS
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# SEMANTIC PARSER & SCHEMA ENFORCEMENT
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# FORENSICS, STATE MACHINE & AI PHYSICS
# ═══════════════════════════════════════════════════════════════════════════════
@st.cache_data(show_spinner=False)
def run_pipeline(uploaded_file):
    try:
        df, vname = semantic_parse(uploaded_file)
        ...
        for i in range(len(ad_events)-1):
            ...
            if days <= 0: 
                days = 0.02 # Safe fallback for 0-day deltas
...
for f in files:
    ...
    with t5:
        ...
        if 'SHAP_Base' in sea.columns and sea['SHAP_Base'].abs().sum() > 0:
            ...
            st.info(f"**Forensic Translation:** Expected Mathematical Burn: **{eb:.1f} MT/d** vs Physically Audited Burn: **{tr['Daily_Burn']:.1f} MT/d**.")
